          ...
          <div class=" px-100 grid grid-cols-2 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-3" style="padding: 0px 20px">
              ...
              <div class="p-5">
                  <a href="/story/1">
                      <h5 class="text-gray-900 font-bold text-2xl tracking-tight mb-2">
                        Kumpulan Cerita Rakyat Jawa Tengah</h5>
                  </a>
                  <p class="font-normal text-gray-700 mb-3">Di sebuah desa, hiduplah sepasang petani tua. Dia adalah Mbok Sirni dan
            ...
            <div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5">
              ...
              <div class="p-5">
                  <a href="#">
                      <h5 class="text-gray-900 font-bold text-2xl tracking-tight mb-2">
                        Berakhlak Baik, Yuk!</h5>
                  </a>
                  <p class="font-normal text-gray-700 mb-3">Here are the biggest
                    Siapa yang sayang Rasulullah? Wah, tentu kita
            ...
            <div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5">
              ...
              <div class="p-5">
                  <a href="#">
                      <h5 class="text-gray-900 font-bold text-2xl tracking-tight mb-2">
                        10 Menit, Kumpulan Dongeng Teladan</h5>
                  </a>
                  <p class="font-normal text-gray-700 mb-3">Buku ini berisi Kumpulan Dongeng  anak yang dilengkapi dengan gambar menarik serta games dan puzzle yang sangat bermanfaat bagi anak.</p>
                  <a class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center"
                      href="/story/3">
                      Read more
                  </a>
