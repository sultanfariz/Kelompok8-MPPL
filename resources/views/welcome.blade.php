...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div
            ...
            <x-app-layout>
                <div class="" style="background: blue; width:100%; height:600px">
                </div>
                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <div class="flex flex-col py-6">
                                <div class="flex flex-row py-6">
                                    <div
                                        class=" px-100 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4" style="padding: 0px 20px">
